...
<link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@700&family=Playpen+Sans:wght@700&display=swap" rel="stylesheet">
    <title>THR Game File Host</title>
    <style>
        body {
...
<body>
    ...
    <div class="main-content">
        <h1>THR Game File Host</h1>
    <h2 style="color: rgb(255, 153, 0); text-align: center; margin-bottom: 30px; text-shadow: 2px 2px 4px rgba(0,0,0,0.3); font-weight: normal; font-size: 18px;">
    Discord Server:
    <a href="https://discord.gg/UDQNUdqhSJ" 
        target="_blank" 
        style="display: inline; color: #79aadb; text-decoration: none; font-size: 18px; text-shadow: 1px 1px 2px rgba(0,0,0,0.2);">
       https://discord.gg/UDQNUdqhSJ
    </a>
    </h2>
